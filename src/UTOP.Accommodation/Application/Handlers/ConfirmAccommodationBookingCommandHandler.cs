...
public sealed class ConfirmAccommodationBookingCommandHandler
{
    private readonly IAccommodationBookingRepository _repository;
    private readonly IClock _clock;

    public ConfirmAccommodationBookingCommandHandler(
    ...
    public async Task HandleAsync(ConfirmAccommodationBookingCommand cmd, CancellationToken ct = default)
    {
